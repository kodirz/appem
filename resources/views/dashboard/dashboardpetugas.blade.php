            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cards.html">Ditanggapi</a>
                        <a class="collapse-item" href="cards.html">Diproses</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="petugas.datapengaduan" class="text-decoration-none">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="data-pengaduan.html" class="text-decoration-none">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            ...
                                            <div class="col-auto">
                                                <i class="fa-solid fa-pencil fa-2x text-gray-300"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="loginpetugas">Logout</a>
                </div>
            </div>
        </div>
    </div>
